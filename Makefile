FILES			= main.c parsing/parsing.c parsing/parsing_map.c parsing/parsing_utils.c reading_data/read_data.c reading_data/read_map.c error/free.c initialisation/init.c initialisation/init_raycasting.c minimap/drawing_onMinimap.c player/key_events.c rendering/render_raycast.c rendering/utils_raycasting.c rendering/drawing_func.c minimap/contour_minimap.c
